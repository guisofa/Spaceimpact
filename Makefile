...
# Arquivos-objeto
objects = spaceimpact.o background.o player.o joystick.o arma.o balas.o inimigos.o chefes.o colisoes.o drops.o
...
drops.o: drops.c drops.h
	$(CC) -c $(CFLAGS) -o drops.o drops.c
